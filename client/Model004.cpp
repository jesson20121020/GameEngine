...
void Model004::renderImGui()
{
  ...
  ImGui::End();
        ...
        view  = glm::translate(view, glm::vec3(_viewPos[0], _viewPos[1], _viewPos[2]));
        projection = glm::perspective(glm::radians(_fov), (float)800 / (float)600, 0.1f, 100.0f);
